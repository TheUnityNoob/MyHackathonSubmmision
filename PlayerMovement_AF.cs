...
namespace AnimFollow
{
	public class PlayerMovement_AF : MonoBehaviour
	{
		...
		void FixedUpdate ()
		{
			...
			MovementManagement(Input.GetAxis("Vertical"), Input.GetAxis("Horizontal"), Input.GetKey(KeyCode.LeftShift), Input.GetKey(KeyCode.LeftControl));
		}

		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

		public void MovementManagement (float vertical, float horizontal, bool walk, bool sneaking)
		{
			...
			if(horizontal >= .1f && !walk)
			{
				// ... set the speed parameter to 5.5f.
				anim.SetFloat(hash.speedFloat, 5.5f, speedDampTime, Time.fixedDeltaTime);
				transform.Rotate(0f,2f,0f);
			}
			else if(horizontal <= -.1f && !walk)
			{
				// ... set the speed parameter to 5.5f.
				anim.SetFloat(hash.speedFloat, 5.5f, speedDampTime, Time.fixedDeltaTime);
				transform.Rotate(0f,-2f,0f);
